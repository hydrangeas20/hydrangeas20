...
| [Behaviour–Mechanism Divergence](https://github.com/hydrangeas20//behaviour-mechanism) | Tracks behavioural and causal mechanistic measurements across transformer training; finds behavioural induction reaches ceiling substantially before activation-patching measurements stabilize, with negative controls, per-head localization, and architecture robustness experiments. |
| [SafetyLens](https://github.com/hydrangeas20/safetylens) | Tests whether safety evaluations remain reliable across evaluation vs. deployment framing, using paired multi-model experiments, automated LLM-as-a-Judge scoring, and statistical analysis of evaluation–deployment divergence. |
